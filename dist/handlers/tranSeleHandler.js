...
const fetchTranslated_1 = __importStar(require("../actions/fetchTranslated"));
const getCursorRange_1 = __importDefault(require("../helpers/getCursorRange"));
function tranSeleHandler(toLang) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (editor !== undefined) {
            ...
            const translated = yield (0, fetchTranslated_1.default)(text, toLang);
